...
public class GroupManageDAO extends EgovAbstractMapper {
	...
	public List<GroupManageVO> selectJqGroupList(GroupManageVO groupManageVO) throws Exception {
		return (List<GroupManageVO>) list("groupManageDAO.selectJqGroupList", groupManageVO);
	}
	
	//jqgrid 총 레코드 갯수
	public int selectJpGroupTotRecords(GroupManageVO groupManageVO) throws Exception{
		return (Integer)selectOne("groupManageDAO.selectJpGroupTotRecords", groupManageVO);
	}
	...
	public void updateJqGroup(Map<String, Object> map) throws Exception {
		update("groupManageDAO.updateJqGroup", map);
	}

	public String selectLastGroupId() {
		// TODO Auto-generated method stub
		return selectOne("groupManageDAO.selectLastGroupId");
	}
}