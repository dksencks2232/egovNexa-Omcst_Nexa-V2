...
public class EgovAuthorGroupController {
    ...
    public String selectAuthorGroupListView(@ModelAttribute("authorGroupVO") AuthorGroupVO authorGroupVO,
    	...
    	//csh 페이징 모듈화
    	PaginationInfo paginationInfo= (PaginationInfo) pageInfoUtil.makePaginationInfo(authorGroupVO);
    	authorGroupVO = (AuthorGroupVO) pageInfoUtil.makeObjectVO(paginationInfo, authorGroupVO);
