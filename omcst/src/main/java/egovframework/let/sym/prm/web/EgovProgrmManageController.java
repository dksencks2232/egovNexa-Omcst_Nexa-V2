...
//		}
	...
	public String selectProgrmList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model, HttpServletRequest request) throws Exception {
...
//		}
	...
	public String insertProgrmList(@RequestParam Map<String, Object> commandMap,@ModelAttribute("searchVO") BoardMasterVO searchVO, @ModelAttribute("progrmManageVO") ProgrmManageVO progrmManageVO, BindingResult bindingResult,
			ModelMap model ) throws Exception {
		//System.out.println("######bbsid0######"+ searchVO.getBbsId());
		String resultMsg = "";
		String sLocationUrl = null;
		// 0. Spring Security 사용자권한 처리
//		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
