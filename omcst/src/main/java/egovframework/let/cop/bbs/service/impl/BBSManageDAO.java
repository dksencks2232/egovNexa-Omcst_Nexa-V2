...
public class BBSManageDAO extends EgovAbstractMapper {
     ...
     * @throws Exception
     */
    public Board insertBoardArticle(Board board) throws Exception {
     ...
     * @throws Exception
     */
    public Board replyBoardArticle(Board board) throws Exception {
	long nttId = (Long)selectOne("BBSManageDAO.selectMaxNttId");
	board.setNttId(nttId);
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardGalleryList(BoardVO boardVO) throws Exception {
	return (List<BoardVO>) list("BBSManageDAO.selectBoardGalleryList", boardVO);
    }
    
    /**
     * 조건에 맞는 갤러리 게시물 목록에 대한 전체 건수를 조회 한다.
     *
     * @param boardVO
     * @return
     * @throws Exception
     */
    public int selectBoardGalleryListCnt(BoardVO boardVO) throws Exception {
	return (Integer)selectOne("BBSManageDAO.selectBoardGalleryListCnt", boardVO);
    }

	public List<BoardVO> selectFixedArticleList(BoardVO boardVO) {
		return (List<BoardVO>) list("BBSManageDAO.selectFixedArticleList", boardVO);
	}

	/*
	 * public List<BoardVO> selectFixedArticleList(BoardVO boardVO) { return
	 * (List<BoardVO>) list("BBSManageDAO.selectFixedArticleList", boardVO); }
	 */
}
