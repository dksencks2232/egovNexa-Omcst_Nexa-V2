package egovframework.omcst.manage.absence.service.dao;
 ...
 * </pre>
 */
@Repository("userAncDAO")
public class UserAncDAO extends EgovAbstractMapper {
	...
	public List<UserAbsnceVO> selectUserAbsnceList(UserAbsnceVO userAbsnceVO) throws Exception {
		return (List<UserAbsnceVO>) list("userAncDAO.selectUserAbsnceList", userAbsnceVO);
	}
    ...
    public int selectUserAbsnceListTotCnt(UserAbsnceVO userAbsnceVO) throws Exception {
        return (Integer)selectOne("userAncDAO.selectUserAbsnceListTotCnt", userAbsnceVO);
    }
	...
	public UserAbsnceVO selectUserAbsnce(UserAbsnceVO userAbsnceVO) throws Exception {
		return (UserAbsnceVO) selectOne("userAncDAO.selectUserAbsnce", userAbsnceVO);
	}
	...
	public void insertUserAbsnce(UserAbsnce userAbsnce) throws Exception {
		insert("userAncDAO.insertUserAbsnce", userAbsnce);
	}
	...
	public void updateUserAbsnce(UserAbsnce userAbsnce) throws Exception {
		update("userAncDAO.updateUserAbsnce", userAbsnce);
	}
	...
	public void deleteUserAbsnce(UserAbsnce userAbsnce) throws Exception {
		delete("userAncDAO.deleteUserAbsnce", userAbsnce);
	}
}
