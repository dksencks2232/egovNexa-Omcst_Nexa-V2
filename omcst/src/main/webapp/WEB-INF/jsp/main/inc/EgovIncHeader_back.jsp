...
<div class="header">
	<div class="jbFixed">
	    <div class="inner">
	        <div class="left_col">
	            <h1 class="logo"><a href="<c:url value='/'/>cmm/main/mainPage.do"><img src="<c:url value='/'/>images/omcstlogo.png" alt="오픈마인즈"></a></h1>
        ...
        <div class="inner">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a href="/ebt_webapp/EgovPageLink.do?link=main/sample_menu/Sample">연차정보 관리</a></li>
                </ul>
            </div>
            ...
            <div class="admin">
                ...
                <ul>
                    ...
                    <li><a href="/ebt_webapp/sec/rgm/EgovAuthorGroupList.do">사용자별권한관리</a></li>
