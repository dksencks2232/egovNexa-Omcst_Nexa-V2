 ...
 * 삭제 처리
 ******************************************************** */
function fnc_userAbsnceDeleteTmp() {
    let varFrom = document.getElementById("userAbsnce");
    let ctx = sessionStorage.getItem("contextpath");

    varFrom.action = ctx+'/removeUserAbsnceTmp';
                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="lastUpdusrPnttm" id="lastUpdusrPnttm" class="f_txt" title="등록일시" type="text" value="${fn:substring(userAbsnce.lastUpdusrPnttm,0,19) }" maxLength="50" readonly>
                                ...
                                <div class="board_view_bot">
                                    <div class="left_col btn3">
                                    	<a href="#LINK" class="btn btn_skyblue_h46 w_100" onclick="fnc_userAbsnceDeleteTmp(); return false;"><spring:message code="button.delete" /></a><!-- 저장 -->
                                    `	<!-- 
                                    	<a href="<c:url value='/removeUserAbsnceTmp'/>?userId=<c:out value='${userAbsnceVO.userId}'/>&amp;selAbsnceAt=<c:out value='${userAbsnceVO.selAbsnceAt}'/>" class="btn btn_skyblue_h46 w_100">
                                    ...
                                    <div class="right_col btn1">
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="JavaScript:fnc_userAbsnceUpdateTmp(); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
                                        <a href="<c:url value='/userManage'/>?pageIndex=<c:out value='${userAbsnceVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${userAbsnceVO.searchKeyword}"/>&amp;searchCondition=1&amp;selAbsnceAt=<c:out value="${userAbsnceVO.selAbsnceAt}"/>" class="btn btn_gray_46 w_100">
