...
<script>
	function fn_authCheck(){ 
		...
		.html('<iframe style="border: 0px; " src="' + BASE_URL+'/authCheckView"' + '" width="100%" height="100%"></iframe>')
		.dialog({
	    	autoOpen: false,
	        modal: true,
	        width: 600,
	...
	function showModalDialogCallback(retVal) {
	    if(retVal) {
	        document.authorManage.authorCode.value = retVal;
	        $('#modalPan').remove();
	    }
	}
            ...
            <div class="layout">
                <div class="content_wrap">
                    <div id="contents" class="content">
						<form:form modelAttribute="authorManage" id="authorManage" name="listForm" method="post" >
                            ...
                            <table summary="권한을 등록하는 테이블입니다.권한 코드,권한 명,설명,등록일자의 정보를 담고 있습니다.">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input name="authorCode" id="authorCode" class="f_txt" type="text"
                                        		value="<c:out value='${authorManage.authorCode}'/>" title="권한코드" placeholder="권한코드"/>
                                        &nbsp;<form:errors path="authorCode" />
                                        <button type="button" style="top:25px" class="btn" onclick="fn_authCheck();">조회</button>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="authorNm" id="authorNm" class="f_txt" type="text" value="<c:out value='${authorManage.authorNm}'/>" maxLength="50" title="권한명" placeholder="권한명"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="authorDc" id="authorDc" class="f_txt w_full" type="text" value="<c:out value='${authorManage.authorDc}'/>" maxLength="50" title="설명" placeholder="설명" />
                                    </td>
                                </tr>
                                <%-- <tr>
                                    <td class="lb">
                                    ...
                                    <td>
                                        <input name="authorCreatDe" id="authorCreatDe" class="f_txt" type="text" value="<c:out value='${authorManage.authorCreatDe}'/>" maxLength="50" readonly="readonly" title="등록일자" placeholder="등록일자"/>
                                    </td>
                                </tr> --%>
                            </table>
                        </div>
