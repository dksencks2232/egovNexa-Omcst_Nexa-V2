                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <div class="condition2">
                                    ...
                                    <a href="<c:url value='/sym/log/SelectLoginLogList.do'/>" class="item btn btn_gray_46 w_100 ml10" onclick="javascript:fn_egov_select_loginLog('1'); return false;"><spring:message code='button.inquire' /></a><!-- 조회 -->
