            ...
            <div class="layout">
               <div class="content_wrap">
                  <div id="contents" class="content">
                              ...
                              <div class="board_view2">
                                 <table>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <input id="" class="f_txt w_full" name="nttSj" title="<spring:message code="cop.nttSj" />" 
                                          		type="text" value='<c:out value="${result.nttSj}" />' maxlength="60"><br/>
                                    ...
                                    <c:if test="${bdMstr.bbsTyCode == 'BBST03'}">
                                       <tr>
                                          ...
                                          <td>
                                             <input id="fixedAt" name="fixedAt" type="checkbox" value='<c:out value="${result.fixedAt}"/>' 
                                             		<c:if test="${result.fixedAt == 'Y'}">checked</c:if>><br />
                                          </td>
                                       </tr>
                                    </c:if>
                                    <tr>
                                       <td class="lb">
                                          <label for="qestnrPurps">
                              ...
                              <div class="board_view2">
                                 <table>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <input id="" class="f_txt w_full" name="nttSj" title="<spring:message code="cop.nttSj" />" type="text" 
                                          		value='<c:out value="${result.nttSj}" />' maxlength="60"><br/>
                                          <form:errors path="nttSj" />
                                       </td>
                                    </tr>
                                 </table>
                                 <textarea id="summernote" name="nttCn">
                     ...
                     <input type="hidden" name="errorMsg" value="<spring:message code='common.update.msg'/>" />
                  </div>
               </div>
            </div>
         </div>
