                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <div class="board_view">
									...
									<c:choose>
										<c:when test="${result.bbsAttrbCode == 'BBSA02'}">
	                                    	<div id="nttCn" >
	                                    		<c:out value="${result.nttCn}" escapeXml="false" />
	                                    	</div>										
										</c:when>
										<c:otherwise>
											<textarea id="nttCn" name="nttCn" class="textarea" cols="30" rows="10" readonly="readonly" title="글내용">
												<c:out value="${result.nttCn}" escapeXml="false" />
											</textarea>
										</c:otherwise>
									</c:choose>
                                    ...
                                    <div class="board_view_bot">
                                        <div class="left_col btn3">
                                        	<c:if test="${result.frstRegisterId == sessionUniqId || role eq 'ROLE_ADMIN'}">
                                            ...
                                            <c:if test="${result.bbsAttrbCode != 'BBSA02' && result.bbsTyCode != 'BBST03'}">
                                        ...
                                        <div class="right_col btn1">
                                            <a href="#LINK" class="btn btn_gray_46 w_100" onclick="javascript:fn_egov_select_noticeList('1'); return false;">목록</a><!-- 목록 -->
                                        </div>
                                    </div>
                                    <!-- // 목록/저장버튼 끝  -->
                                </div>
