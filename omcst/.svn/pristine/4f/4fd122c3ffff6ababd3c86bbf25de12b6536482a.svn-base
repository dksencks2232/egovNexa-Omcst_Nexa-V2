                                ...
                                <div class="condition">
                                	...
                                	<form name="frm" method="get" action = "<c:url value='/cop/com/selectBBSUseInf.do'/>">
	                                    ...
	                                    <span class="item f_search">
	                                        ...
	                                        <button class="btn" type="submit" onclick="fn_egov_select_bbsUseInfs('1'); return false;"><spring:message code='button.inquire' /></button>
	                                    </span>
	                                    
	                                   <%--  <span class="ml10">
	                                    	<button class="btn btn_gray_46 w_100" type="submit" onclick="fn_egov_select_bbsUseInfs('1'); return false;"><spring:message code='button.inquire' /></button><!-- 조회 -->
	                                    </span> --%>
                                	</form>
