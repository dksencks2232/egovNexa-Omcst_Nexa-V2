...
public class EgovRoleManageController {
	...
	public String selectRoleList(@ModelAttribute("roleManageVO") RoleManageVO roleManageVO,
    	...
    	//csh 페이징 모듈화
    	PaginationInfo paginationInfo= (PaginationInfo) pageInfoUtil.makePaginationInfo(roleManageVO);
    	roleManageVO = (RoleManageVO) pageInfoUtil.makeObjectVO(paginationInfo, roleManageVO);
