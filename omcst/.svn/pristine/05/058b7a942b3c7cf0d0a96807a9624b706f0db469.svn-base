...
<script type="text/javascript">
    ...
    function fn_egov_select_brdMstrList(){
        ...
        document.getElementById("rdo1").value = '';
        document.getElementById("rdo2").value = '';
        document.boardMaster.submit();  
    }   
    ...
    function fn_egov_move(){
        document.boardMaster.action = "<c:url value='/sym/prm/EgovProgramListRegist.do'/>";
        document.boardMaster.submit();          
    }
                    ...
                    <div class="layout">        
                        <div class="content_wrap">
                            <div id="contents" class="content">
								...
								<input name="provdUrl" type="hidden" value="<c:out value='${result.provdUrl}'/>" />
                                ...
                                <div class="board_view2">
                                    <table summary="게시판명,게시판 소개,게시판 유형,게시판 속성,답장가능여부, ..입니다">
                                        ...
                                        <tr>
                                            ...
                                            <td class="rdoSet">
                                                    <input type="radio" id="rdo1" name="useAt"  value="Y" <c:if test="${result.useAt == 'Y'}"> checked="checked"</c:if>>
                                                    <spring:message code="button.use" /><!-- 사용 --> &nbsp;&nbsp;
                                                    <input type="radio" id="rdo2" name="useAt" value="N" <c:if test="${result.useAt == 'N'}"> checked="checked"</c:if>>
                                        ...
                                        <tr>
		                                    ...
		                                    <td>
		                                         <a href="#LINK" class="lnk" onclick="javascript:fn_egov_move()"> <c:url value="${result.provdUrl}" /></a>
		                                     </td>
                                        </tr>
