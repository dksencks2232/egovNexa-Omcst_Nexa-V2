...
public class EgovAuthorRoleController {
	...
	public String selectAuthorRoleList(@ModelAttribute("authorRoleManageVO") AuthorRoleManageVO authorRoleManageVO,
    	...
    	//csh 페이징 모듈화
    	PaginationInfo paginationInfo= (PaginationInfo) pageInfoUtil.makePaginationInfo(authorRoleManageVO);
    	authorRoleManageVO = (AuthorRoleManageVO) pageInfoUtil.makeObjectVO(paginationInfo, authorRoleManageVO);
