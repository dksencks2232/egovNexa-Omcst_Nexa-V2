                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="condition2">
                                    ...
                                    <span class="item f_search">
                                        ...
                                        <button class="btn" type="submit" onclick="javascript:fncSelectLoginPolicyList('1')"><spring:message code='button.inquire' /></button>
                                       
                                    </span>
                                    
                                   <%--  <span>
                                    	<button class="btn btn_gray_46 w_100" type="submit" onclick="javascript:fncSelectLoginPolicyList('1')"><spring:message code='button.inquire' /></button><!-- 조회 -->
                                    </span> --%>
