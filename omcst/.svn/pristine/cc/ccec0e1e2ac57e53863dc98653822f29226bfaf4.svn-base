...
public class EgovLoginPolicyController {
	...
	public String selectLoginPolicyList(@ModelAttribute("loginPolicyVO") LoginPolicyVO loginPolicyVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		/** paging */
		//csh 페이징 모듈화
		PaginationInfo paginationInfo= (PaginationInfo) pageInfoUtil.makePaginationInfo(loginPolicyVO);
		loginPolicyVO = (LoginPolicyVO) pageInfoUtil.makeObjectVO(paginationInfo, loginPolicyVO);
