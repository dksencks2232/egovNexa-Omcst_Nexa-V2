...
public class EgovLoginLogController {
	...
	public String selectLoginLogInf(HttpServletRequest request, @ModelAttribute("searchVO") LoginLog loginLog, ModelMap model) throws Exception {
		...
		//csh 페이징 모듈화
		PaginationInfo paginationInfo= (PaginationInfo) pageInfoUtil.makePaginationInfo(loginLog);
		loginLog = (LoginLog) pageInfoUtil.makeObjectVO(paginationInfo, loginLog);
