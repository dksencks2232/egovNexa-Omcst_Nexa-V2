...
public class EgovBBSUseInfoManageController {
	...
	public String selectBBSUseInfs(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		//csh 페이징 모듈화
		PaginationInfo paginationInfo= (PaginationInfo) pageInfoUtil.makePaginationInfo(bdUseVO);
		bdUseVO = (BoardUseInfVO) pageInfoUtil.makeObjectVO(paginationInfo, bdUseVO);
