...
public interface EgovMenuManageService {
	 ...
	 * @exception Exception
	 */
	List<?> selectMainMenuList(MenuManageVO vo) throws Exception;
	 ...
	 * @throws Exception
	 */
	Map<String,Object> selectNaviTitle(Map<String, Object> vo) throws Exception;
