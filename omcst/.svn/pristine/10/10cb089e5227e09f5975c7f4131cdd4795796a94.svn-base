                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="<c:url value='/cop/com/selectTemplateInfs.do'/>" class="btn btn_gray_46 w_100" onclick="javascript:fn_egov_select_tmplatInfo(); return false;"><spring:message code="button.list" /></a><!-- 목록 -->
                                    </div>
                                </div>
                                <!-- 버튼 끝 -->
