...
public class MenuManageDAO extends EgovAbstractMapper{
	 ...
	 * @exception Exception
	 */
	public List<?> selectMainMenuList(MenuManageVO vo) throws Exception{
		return list("menuManageDAO.selectMainMenuList", vo);
	}
	...
	public List<?> selectSubMenuList(MenuManageVO vo) throws Exception{
		return list("menuManageDAO.selectSubMenuList", vo);
	}
	 ...
	 * @throws Exception
	 */
	public Map<String,Object> selectNaviTitle(Map<String, Object> vo) throws Exception{
		return (Map<String, Object>)selectOne("menuManageDAO.selectNaviTitle", vo);
	}
	 ...
	 * @exception Exception
	 */
	public List<MenuManageVO> selectUpperMenuNo() throws Exception{
		return selectList("menuManageDAO.selectUpperMenuNo");
	}
	 ...
	 * @exception Exception
	 */
	public String selectrMenuNo(int menuNo) throws Exception{
		return selectOne("menuManageDAO.selectMenuNo",menuNo);
	}
}