...
public class EgovFileMngController {
	...
	public String selectImageFileInfs(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		...
		String  limitYn= (String) commandMap.get("limitYn");
		//System.out.println("file####################"+limitYn);
		fileVO.setFileSn(limitYn);
		fileVO.setAtchFileId(atchFileId);
	...
	@PostMapping(value="/ajaxDeleteFile", produces = "application/text; charset=UTF-8")
	@ResponseBody
	public ResponseEntity<String> ajaxDeleteFile(@RequestParam(value="params", required=true)String params, HttpServletResponse response, FileVO fileVO)throws Exception{
		
		String[] paramArray= params.split(",");
		
		fileVO.setAtchFileId(paramArray[0]);
		fileVO.setFileSn(paramArray[1]);
