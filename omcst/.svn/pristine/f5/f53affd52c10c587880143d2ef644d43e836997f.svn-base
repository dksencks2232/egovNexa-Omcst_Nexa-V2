                    ...
                    <div class="layout">
                        <div class="content_wrap">
                            <div id="contents" class="content">
								...
								<form:form modelAttribute="userManageVO" action="${pageContext.request.contextPath}/userInsertToast" name="userManageVO" method="post" >
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        <a href="#LINK" class="btn btn_blue_46 w_100"onclick="JavaScript:fn_insertToast(); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
