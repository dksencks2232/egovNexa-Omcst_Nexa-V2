                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="<c:url value='/uat/uap/selectLoginPolicyList.do'/>?pageIndex=<c:out value='${loginPolicyVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${loginPolicyVO.searchKeyword}"/>&amp;searchCondition=1" class="btn btn_gray_46 w_100" onclick="fncSelectLoginPolicyList(); return false;">
