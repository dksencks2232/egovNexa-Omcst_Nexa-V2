<%--
  ...
  Description : UserAbsnceRegist 화면
                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        <a href="#LINK" class="btn btn_blue_46 w_100" onclick="JavaScript:fnc_userAbsnceInsertTmp(); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
						        ...
						        <input type="hidden" id="rMessage" value="<spring:message code='common.regist.msg' />"/>
