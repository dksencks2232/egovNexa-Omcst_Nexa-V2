                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="board_view2">
                                    <table summary="분류코드, 분류코드명, 분류코드설명, 사용여부를 입력하는 공통분류코드 등록 테이블이다.">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input class="f_txt" type="text" path="clCode" maxlength="3" id="clCode" Placeholder="분류코드"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input class="f_txt w_full" type="text" path="clCodeNm" maxlength="60" id="clCodeNm" Placeholder="분류코드명"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:textarea class="f_txtar w_full h_80" path="clCodeDc" cols="30" rows="10" id="clCodeDc" Placeholder="분류코드설명"/>
                                                <form:errors path="clCodeDc" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="lb">
                                            	<label for="useAt" class="display_n">사용여부</label>
                                                <span class="req">필수</span>
                                            </td>
                                            <td class="display_fc1">
                                            	<span class="m_display_ib ">사용여부</span>
                                ...
                                <div class="board_view_bot">
                                    ...
                                    <div class="right_col btn1">
                                        ...
                                        <a href="#LINK" class="btn btn_gray_46 w_100" onclick="fn_egov_list_CmmnClCode(); return false;"><spring:message code="button.list" /></a><!-- 목록 -->
                                    </div>
                                </div>
                                <!-- // 목록/저장버튼 끝  -->
