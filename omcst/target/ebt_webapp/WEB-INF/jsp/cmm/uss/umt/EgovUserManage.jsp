                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <div class="condition">
                                    ...
                                    <span class="ml20">
                                    	<button class="btn btn_blue_46 w_100" type="submit" onclick="javascript:fnSearch(); return false;"><spring:message code='button.inquire' /></button><!-- 조회 -->
                                    </span>
								...
								<div class="board_list_top">
	                            	...
	                            	<div class="right_col">
										<a href="#LINK" class="item btn btn_red_46 w_100" onclick="javascript:fnDeleteUser(); return false;"><spring:message code="button.delete" /></a><!-- 삭제 -->
