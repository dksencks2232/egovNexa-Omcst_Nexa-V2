...
function fncManageChecked() {
	console.log("fncManageChecked() 실행")
    ...
    console.log(document.listForm.userIds.value);
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
                                ...
                                <div class="board_list_top">
                                    ...
                                    <div class="right_col">
                                    	<a href="#LINK" class="btn btn_red_46 w_100" onclick="javascript:fncAuthorGroupDeleteList()">등록취소</a><!-- 등록취소 -->
