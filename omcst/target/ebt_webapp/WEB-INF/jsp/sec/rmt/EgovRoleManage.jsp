                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="condition2">
                                    ...
                                    <span class="item f_search">
                                        ...
                                        <button class="btn" type="submit" onclick="javascript:fncSelectRoleList('1')"><spring:message code='button.inquire' /></button>
                                    </span>
                                    <%-- <span>
                                    	<button class="btn btn_gray_46 w_100" type="submit" onclick="javascript:fncSelectRoleList('1')"><spring:message code='button.inquire' /></button><!-- 조회 -->
                                    </span> --%>
                                </div>
                                <!--// 검색조건 -->
                                ...
                                <div class="board_list_top">
                                    ...
                                    <div class="right_col">
                                    	<a href="#LINK" class="btn btn_red_46 w_100" onclick="javascript:fncRoleListDelete()"><spring:message code='button.delete' /></a><!-- 삭제 -->
